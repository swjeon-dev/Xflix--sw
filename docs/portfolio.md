...
처음부터 정해진 디자인 시안이 있었던 프로젝트는 아니었습니다. 대신 초기 화면 설계 단계에서 AI를 참고해 화면 초안과 사용자 흐름을 빠르게 살펴보고, 그중 실제 서비스에 적합한 방향만 남겨 직접 수정하고 구현했습니다. 결과적으로 AI는 구상을 돕는 도구로 활용했고, 최종 UI 구조와 사용자 경험, 기술 구현은 스스로 판단하며 완성했습니다.
