...
import EpisodeDetail from './episode-row'
...
function EpisodesModal({
  ...
  }, [isOpen, selectedEpisode, selectedIndex, episodes, onClose, onSelectEpisode])
      ...
      >
        ...
        >
          <header className='flex items-center justify-between gap-4 px-4 py-3 border-b border-white/10 shrink-0'>
            <h2 id='episodes-modal-title' className='text-lg font-semibold truncate'>
              {seasonName}
              {selectedEpisode && (
